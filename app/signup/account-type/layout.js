...
import BootstrapClientJs from '@/app/components/bootstrapJsClient/bootstrapClient';
import Head from 'next/head';
import './component/style.css'


export const metadata = {
  title: 'Account Type | Ticket Pass',
...
export default function AccountLayout({ children }) {
  return (
    <html lang="en">
      ...
      <body style={{ backgroundImage: "url('/account-type-img.png')"}}>{children}</body>
      <BootstrapClientJs />
    </html>
  )
}
