                ...
                <div className="container col-xl-10 col-xxl-8 px-4 py-5">
                    ...
                    <div className="col-md-10 mx-auto col-lg-5">
                        ...
                        <div className="form-group mb-3">
                            <h2 className="text-purple account-title pb-0 mb-0">Business information</h2>
                            <div className='account-setup'>Tell us about your business.</div>
                        </div>
                        <div className="form-floating mb-3">
                            <input type="text" className="form-control" id="floatingInput" placeholder="Business Name" />
